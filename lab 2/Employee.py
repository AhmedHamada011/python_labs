...
class Employee:
    ...
    def transfer(self, department):
        self.department = department
        db.update(f"update `employee` set department =%s where first_name= %s and last_name = %s",
    ...
    def list_employees():
        ...
        for emp in employees:
            print(f"first name is {emp[1]}")
            print(f"last name is {emp[2]}")
            print(f"salary is {emp[3]}")
            print(f"age is {emp[4]}")
            print(f"department is {emp[5]}")
            print("=============================")


# emp = Employee("ahmed", "hamada", 15, "tech", 2000)
